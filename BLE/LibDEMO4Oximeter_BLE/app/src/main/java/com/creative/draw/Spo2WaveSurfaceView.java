 ...
 * @deprecated
 */
public class Spo2WaveSurfaceView extends BaseSurfaceView {
	...
	public Spo2WaveSurfaceView(Context context) {
		super(context);
	}

	public Spo2WaveSurfaceView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public Spo2WaveSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
