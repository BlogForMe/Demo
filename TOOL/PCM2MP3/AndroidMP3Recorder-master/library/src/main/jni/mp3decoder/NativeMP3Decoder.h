 ...
 */
JNIEXPORT jint JNICALL Java_com_czt_mp3recorder_NativeMP3Decoder_initAudioPlayer
 ...
 * Signature: ([SI)I
 */
JNIEXPORT jint JNICALL Java_com_czt_mp3recorder_NativeMP3Decoder_getAudioBuf
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_czt_mp3recorder_NativeMP3Decoder_closeAduioFile
  (JNIEnv *, jobject);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_czt_mp3recorder_NativeMP3Decoder_getAudioSamplerate
  (JNIEnv *, jobject);
